...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/ancient-fog-5e72)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ancient-fog-5e72
```

A live public deployment of this template is available at [https://ancient-fog-5e72.templates.workers.dev](https://ancient-fog-5e72.templates.workers.dev)
